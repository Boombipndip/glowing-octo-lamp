...
def storm():
	...
	time.sleep(2)
	tip = input("Type f to fight or t to tip your hat > ")
	if tip == "f" or tip == "F":
...
def go_to_deck():
	...
	time.sleep(3)
	attack1 = input("type l for leg sweep or type c for a chop > ")
	if attack1 == "l":
...
def go_to_captain():
	...
	choice1 = input("type s to hit her or type k to blow her a kiss > ")
	if choice1 == "s":
...
def pick_a_door():
	...
	time.sleep(2)
	pick1 = input("Pick door 1, 2, or 3? > ")
...
def treasure():
	...
	time.sleep(2)
	choice2 = input("type j to just get the jewels or type a to get it all > ")
	if choice2 == "j":
...
def escape():
	...
	time.sleep(3)
	escape1 = input("type s to swim or g to go back how you came > ")
	if escape1 == "s":
